...
# Branch predictor is not set here, so the CPU will run without any specific branch prediction mechanism.
...
print(f"Starting simulation with the 'hello' program without branch predictor.")
